...
## [0.24.0](https://github.com/netbospl/cua/compare/cua-driver-rs-v0.23.2...cua-driver-rs-v0.24.0) (2026-09-02)


### ⚠ BREAKING CHANGES

* **cua-driver:** remove browser approval tokens ([#3185](https://github.com/netbospl/cua/issues/3185))
* **cua-driver:** make native desktop actions snapshot-safe ([#2783](https://github.com/netbospl/cua/issues/2783))
...
* **cua-driver:** add implicit lifecycle sessions ([#3013](https://github.com/netbospl/cua/issues/3013)) ([858ef13](https://github.com/netbospl/cua/commit/858ef13a5b1f2630b074d8f588a25cb0b19cab25))
* **cua-driver:** add macOS Spaces awareness to list_windows ([#2850](https://github.com/netbospl/cua/issues/2850)) ([f7404b4](https://github.com/netbospl/cua/commit/f7404b40287c128b15afa30b6c6f9024cbf081b8))
* **cua-driver:** add session-based Agent View across desktops ([#3431](https://github.com/netbospl/cua/issues/3431)) ([57981a1](https://github.com/netbospl/cua/commit/57981a16f8c16a72955ac06d3a98dbcc0f9ca4b6))
* **cua-driver:** add trusted KDE KWin Wayland target identity adapter ([#3336](https://github.com/netbospl/cua/issues/3336)) ([9596fb3](https://github.com/netbospl/cua/commit/9596fb334f3eeec541979ccf5f0ef9ef360da0c6))
* **cua-driver:** add verified semantic window framing ([#2772](https://github.com/netbospl/cua/issues/2772)) ([fb39144](https://github.com/netbospl/cua/commit/fb3914475b9cba97376a6b9b739077cc0994d15f))
* **cua-driver:** advertise native Wayland build features ([#2669](https://github.com/netbospl/cua/issues/2669)) ([31c61dd](https://github.com/netbospl/cua/commit/31c61dd161ea4a27a5e719e71a2eb469b89d924d))
* **cua-driver:** apply capability manifests across permission profiles ([#3015](https://github.com/netbospl/cua/issues/3015)) ([3a53e53](https://github.com/netbospl/cua/commit/3a53e53f99dcf8d5ed761c5cd0b5dd039c916121))
* **cua-driver:** configure embedded daemon overlay ([#3280](https://github.com/netbospl/cua/issues/3280)) ([3ae080d](https://github.com/netbospl/cua/commit/3ae080d366b0fc514ef03b8f5136f29e7477c2ae))
* **cua-driver:** drop the session orb from the cursor badge ([#2842](https://github.com/netbospl/cua/issues/2842)) ([59f280e](https://github.com/netbospl/cua/commit/59f280e485be4f58811bda6a9e2dbe7632b9b63c))
* **cua-driver:** exact-target macOS background input v1 ([#2837](https://github.com/netbospl/cua/issues/2837)) ([1b2cb5a](https://github.com/netbospl/cua/commit/1b2cb5a706c3e5d636b683ab15336dbf35e579e0))
* **cua-driver:** extend Project Centennial across desktop platforms ([#3189](https://github.com/netbospl/cua/issues/3189)) ([a744308](https://github.com/netbospl/cua/commit/a74430843663d3840dffbee04c2e112783ad238e))
* **cua-driver:** make native desktop actions snapshot-safe ([#2783](https://github.com/netbospl/cua/issues/2783)) ([d8ae6df](https://github.com/netbospl/cua/commit/d8ae6df643df5049505a327b88abc2644a25b209))
* **cua-driver:** make native selection and editing foreground-safe ([#2789](https://github.com/netbospl/cua/issues/2789)) ([815013a](https://github.com/netbospl/cua/commit/815013a88c02d2c8c3e40f98d41fac84f037f91d))
* **cua-driver:** Project Centennial preview ([#3188](https://github.com/netbospl/cua/issues/3188)) ([61e51cd](https://github.com/netbospl/cua/commit/61e51cddc48edcd0ae350a1744890c04951027f1))
* **cua-driver:** remove browser approval tokens ([#3185](https://github.com/netbospl/cua/issues/3185)) ([0d7c011](https://github.com/netbospl/cua/commit/0d7c011eb31526d9c2b500806f35523dc2bdfb0e))
* **cua-driver:** support Prime Agent skill onboarding ([#2944](https://github.com/netbospl/cua/issues/2944)) ([0f796d0](https://github.com/netbospl/cua/commit/0f796d0659877bee3404d11eef566cfbcbf8edf1))


### Bug Fixes

* **cua-driver:** accept host identity in embedded health check ([#2170](https://github.com/netbospl/cua/issues/2170)) ([8a3d79a](https://github.com/netbospl/cua/commit/8a3d79aa79443ee3b821903c3e596463732ed18f))
* **cua-driver:** admit stable local history signatures ([#3262](https://github.com/netbospl/cua/issues/3262)) ([4864ccd](https://github.com/netbospl/cua/commit/4864ccd42673eaa535d5e5ad01f2e30b484a0b02))
* **cua-driver:** advertise refusals in the MCP outputSchema ([#2968](https://github.com/netbospl/cua/issues/2968)) ([dc6f32c](https://github.com/netbospl/cua/commit/dc6f32cd4d32bb0a60e18674086f443f9d9d8288))
* **cua-driver:** align agent guidance with lifecycle sessions ([#3041](https://github.com/netbospl/cua/issues/3041)) ([dbde09e](https://github.com/netbospl/cua/commit/dbde09e0bfd39abbc374e2e9aade86086e773bb8))
* **cua-driver:** align Wayland capture, focus, and overlays ([#3152](https://github.com/netbospl/cua/issues/3152)) ([2fc59ea](https://github.com/netbospl/cua/commit/2fc59ea943a03e7ab74f948b478afac6765493b5))
* **cua-driver:** attribute hosted Windows apps by window ([#3227](https://github.com/netbospl/cua/issues/3227)) ([30d9130](https://github.com/netbospl/cua/commit/30d9130f7c747d9d3ecb2a5eca5b53366db5f1bb))
* **cua-driver:** avoid accessibility advertise on Cinnamon ([#2784](https://github.com/netbospl/cua/issues/2784)) ([b3ba121](https://github.com/netbospl/cua/commit/b3ba12126188e1540b93d7c51d55926299fd36ab))
* **cua-driver:** avoid retrying deferred text writes ([7e0d6bc](https://github.com/netbospl/cua/commit/7e0d6bcb5d7ca55d9da1ff3e8acc1bdddf6fa422))
* **cua-driver:** bind uninstall signals to process generation ([#3446](https://github.com/netbospl/cua/issues/3446)) ([63c700d](https://github.com/netbospl/cua/commit/63c700d78aec868e7151c8d982263a4f7f146ade))
* **cua-driver:** block uinput pointer hotplug on KDE X11 ([#2888](https://github.com/netbospl/cua/issues/2888)) ([56f13c3](https://github.com/netbospl/cua/commit/56f13c360a8b678960747c50f2680e40c14ae346))
* **cua-driver:** bound large macOS text synthesis ([#2863](https://github.com/netbospl/cua/issues/2863)) ([a6b87e0](https://github.com/netbospl/cua/commit/a6b87e01af9c3f291a40a9d7f4e6301418b2a8ab))
* **cua-driver:** bound Linux AT-SPI listener startup ([#2827](https://github.com/netbospl/cua/issues/2827)) ([ed3c365](https://github.com/netbospl/cua/commit/ed3c365c954446c774c422e8018541e56155dd6a))
* **cua-driver:** bound Linux snapshots after app exit ([#2822](https://github.com/netbospl/cua/issues/2822)) ([d1c5a7a](https://github.com/netbospl/cua/commit/d1c5a7a90b23a37a18838d9c2122d003d00e7ecf))
* **cua-driver:** bound Windows app-name lookup ([#2858](https://github.com/netbospl/cua/issues/2858)) ([2be7aab](https://github.com/netbospl/cua/commit/2be7aab3de35bdffa9d8ad767471c0699d36d6e5))
* **cua-driver:** bound Windows installed-app discovery ([#2855](https://github.com/netbospl/cua/issues/2855)) ([ea971ef](https://github.com/netbospl/cua/commit/ea971ef06d4ebeda16c6947cb2bca2dd875d2ddc))
* **cua-driver:** clarify synthetic browser click outcomes ([#2866](https://github.com/netbospl/cua/issues/2866)) ([197c518](https://github.com/netbospl/cua/commit/197c518c9c364bd30da8bc076748ea82ed093e27))
* **cua-driver:** clean up Chromium remote debugging after browser sessions ([#3372](https://github.com/netbospl/cua/issues/3372)) ([85d7779](https://github.com/netbospl/cua/commit/85d77792e2f400a88f4b77c1218e388945c4b01c))
* **cua-driver:** clean up unresolved Chrome consent UI ([#3468](https://github.com/netbospl/cua/issues/3468)) ([e729547](https://github.com/netbospl/cua/commit/e7295472e196b22e1d02a69441b315a3776d50fb))
* **cua-driver:** constrain incompatible zune-core resolution ([#2984](https://github.com/netbospl/cua/issues/2984)) ([1979ab7](https://github.com/netbospl/cua/commit/1979ab73fdcdba130a54467ca7072c447011f7ab))
* **cua-driver:** drop the stale 0.17 version from element_index messages ([e14891a](https://github.com/netbospl/cua/commit/e14891ae957d710e4e5cbdc1e08e8bffd355cd88))
* **cua-driver:** explain permanent scope recovery ([#2857](https://github.com/netbospl/cua/issues/2857)) ([9110d9f](https://github.com/netbospl/cua/commit/9110d9fd69c7fda41caab3aaac9df80c87bdab2f))
* **cua-driver:** fail closed on X11 overlay shape errors ([#1818](https://github.com/netbospl/cua/issues/1818)) ([0462954](https://github.com/netbospl/cua/commit/0462954cfb9843ca0cc43f49262acf0e69e3517d))
* **cua-driver:** focus exact target for native menus ([#2788](https://github.com/netbospl/cua/issues/2788)) ([2269fa3](https://github.com/netbospl/cua/commit/2269fa352a801bcf1505ac3af8b125db742a4b82))
* **cua-driver:** hard-bound Windows UIA provider calls ([#2117](https://github.com/netbospl/cua/issues/2117)) ([c9c6607](https://github.com/netbospl/cua/commit/c9c660770a26c2f0024b9be1079fac0d4c9effff))
* **cua-driver:** harden consented existing-profile attachment ([#3211](https://github.com/netbospl/cua/issues/3211)) ([3f791b2](https://github.com/netbospl/cua/commit/3f791b2cfec23d690cd34e6d275b6cbe1a8acc05))
* **cua-driver:** harden cross-platform e2e evidence ([99f27ee](https://github.com/netbospl/cua/commit/99f27eeb96481a155fe10f6dee6a131cc0de8b9e))
* **cua-driver:** harden Windows discovery and foreground input ([#2812](https://github.com/netbospl/cua/issues/2812)) ([441cae0](https://github.com/netbospl/cua/commit/441cae0d4d4048524ce2f7eeabfb63a6c9a422d3))
* **cua-driver:** hide policy-disabled MCP tools ([#3132](https://github.com/netbospl/cua/issues/3132)) ([1532830](https://github.com/netbospl/cua/commit/1532830d3d5c6e5db22198130d82a4741a7b4a2f))
* **cua-driver:** honor HERMES_HOME for skill links ([#3291](https://github.com/netbospl/cua/issues/3291)) ([9a61050](https://github.com/netbospl/cua/commit/9a61050e3474fc9488d7adc85184299f02514d0e))
* **cua-driver:** ignore macOS compositor sibling surfaces ([#2908](https://github.com/netbospl/cua/issues/2908)) ([df57e61](https://github.com/netbospl/cua/commit/df57e610d3f2e9c07aac59d4896d48656490e1cc))
* **cua-driver:** index writable native value controls ([46fc5cb](https://github.com/netbospl/cua/commit/46fc5cb7c2b477ba3194a792580dab4a595a5ec5))
* **cua-driver:** keep macOS daemon stable during permission setup ([#3314](https://github.com/netbospl/cua/issues/3314)) ([dbf0d3a](https://github.com/netbospl/cua/commit/dbf0d3a450d9c4fc3a0a768faf0ce9b3283f908e))
* **cua-driver:** keep remote debugging enabled when a restart is needed ([#2911](https://github.com/netbospl/cua/issues/2911)) ([f5b15cc](https://github.com/netbospl/cua/commit/f5b15cccf6a9f0424dd2d83f730b523c4be21df0)), closes [#2892](https://github.com/netbospl/cua/issues/2892)
* **cua-driver:** keep Windows autostart on the junction path ([#2809](https://github.com/netbospl/cua/issues/2809)) ([06f0c04](https://github.com/netbospl/cua/commit/06f0c048fb11b1780e61252eb41a2b968865a8a7))
* **cua-driver:** keep Windows cursor visible without focus theft ([#2864](https://github.com/netbospl/cua/issues/2864)) ([2e7a412](https://github.com/netbospl/cua/commit/2e7a41215ec9e3594567029aad07450c3d731721))
* **cua-driver:** launch desktop AppsFolder apps on Windows ([#2862](https://github.com/netbospl/cua/issues/2862)) ([fb2a6f6](https://github.com/netbospl/cua/commit/fb2a6f60522ebf132270a3377c9a0496d2c0ba98))
* **cua-driver:** launch isolated browser without pid ([#3208](https://github.com/netbospl/cua/issues/3208)) ([eaf5a34](https://github.com/netbospl/cua/commit/eaf5a34ea7804f8837bf39f7453e4beb5e6dce39))
* **cua-driver:** Linux cursor overlay compositing, xrdp-family servers, and resting float ([#2940](https://github.com/netbospl/cua/issues/2940)) ([997d6d8](https://github.com/netbospl/cua/commit/997d6d86433254ccf12e5dbf1edcb46bf05eb5ac))
* **cua-driver:** make Agent View opt-in by default ([8d94261](https://github.com/netbospl/cua/commit/8d942610dc6c43b97d0ca54761a998ae21ee1fed))
* **cua-driver:** make MCP output schemas object-rooted ([96d87ad](https://github.com/netbospl/cua/commit/96d87adb248d746aed2a5427b1a256dbd3f1ae1a))
* **cua-driver:** make Windows browser prepare language independent ([#3135](https://github.com/netbospl/cua/issues/3135)) ([9bf47f6](https://github.com/netbospl/cua/commit/9bf47f65dda1bc33bdd19dabb94c56b691f39ca0))
* **cua-driver:** match canonical Windows executable paths ([#3299](https://github.com/netbospl/cua/issues/3299)) ([a682895](https://github.com/netbospl/cua/commit/a6828955187f3554682065c88f6cb770f107095a))
* **cua-driver:** normalize legacy dispatch before authorization ([#3037](https://github.com/netbospl/cua/issues/3037)) ([d138baa](https://github.com/netbospl/cua/commit/d138baa96a1b4a379dfb498c17101f20cfcf7aef))
* **cua-driver:** open Finder folder URLs reliably ([13057dc](https://github.com/netbospl/cua/commit/13057dc6c8c08da71b8e06a63831ccb5b6870bc5))
* **cua-driver:** persist macOS direct capture verification ([#2904](https://github.com/netbospl/cua/issues/2904)) ([605ce1a](https://github.com/netbospl/cua/commit/605ce1aec80eb73e23ea4c3622b935147a80a572))
* **cua-driver:** prefer semantic routes before GUI fallback ([6f2faf9](https://github.com/netbospl/cua/commit/6f2faf9f9c0ea2db3d0b731d45c6d80a9de23db5))
* **cua-driver:** preserve direct MCP session ownership ([#3079](https://github.com/netbospl/cua/issues/3079)) ([d509687](https://github.com/netbospl/cua/commit/d5096871d088c2e5b5942d678f2c127840061d7d))
* **cua-driver:** preserve embedded telemetry preference ([#3277](https://github.com/netbospl/cua/issues/3277)) ([2c8fa2a](https://github.com/netbospl/cua/commit/2c8fa2a73d87d858520a3acfabc9b6a54479960c))
* **cua-driver:** preserve history admission on macOS relaunch ([#3245](https://github.com/netbospl/cua/issues/3245)) ([9045b0c](https://github.com/netbospl/cua/commit/9045b0c74f7c7de72fde3d9dc622f2cacf1cf848))
* **cua-driver:** preserve named CLI sessions ([#3144](https://github.com/netbospl/cua/issues/3144)) ([1803e52](https://github.com/netbospl/cua/commit/1803e52d0c4a94d88787706cfe89eccb6dc723db))
* **cua-driver:** preserve TCC across release updates ([#3297](https://github.com/netbospl/cua/issues/3297)) ([1542a71](https://github.com/netbospl/cua/commit/1542a717ac65b500d1a524152bcf742d4d311c63))
* **cua-driver:** preserve verified selection readbacks ([dc0af9b](https://github.com/netbospl/cua/commit/dc0af9b23ca8d866540b9ed2b4e4ad7b8b0c4ffb))
* **cua-driver:** prevent Linux uinput pointer panics ([#2736](https://github.com/netbospl/cua/issues/2736)) ([9fde53e](https://github.com/netbospl/cua/commit/9fde53e1fb190834054eb36e7574bc0b523831e2))
* **cua-driver:** quiesce idle Wayland overlay ([#2828](https://github.com/netbospl/cua/issues/2828)) ([35b71a0](https://github.com/netbospl/cua/commit/35b71a0ebd081c333bf53af6b386ef4798dd05b1))
* **cua-driver:** reap Linux launch_app children instead of leaking zombies ([#2974](https://github.com/netbospl/cua/issues/2974)) ([f91d78e](https://github.com/netbospl/cua/commit/f91d78e49a74fd7a690100957886e93e185655e2))
* **cua-driver:** record launch provenance for sessionless launch_app so kill_app can reprove it ([#2966](https://github.com/netbospl/cua/issues/2966)) ([b065550](https://github.com/netbospl/cua/commit/b06555075fc0ccc14df7e17d33b7eb27d97c9c53)), closes [#2965](https://github.com/netbospl/cua/issues/2965)
* **cua-driver:** refuse minimized Windows element actions ([8a9b7ba](https://github.com/netbospl/cua/commit/8a9b7baa32bb5b7ea48a1ee6ffc1d87a433405e4))
* **cua-driver:** refuse unproven Wayland window capture ([#3200](https://github.com/netbospl/cua/issues/3200)) ([c78c1d8](https://github.com/netbospl/cua/commit/c78c1d873b5c091a951716559d2ccc1dc2f7a0e6))
* **cua-driver:** reject misplaced MCP permission flags ([#3085](https://github.com/netbospl/cua/issues/3085)) ([a5bc265](https://github.com/netbospl/cua/commit/a5bc2651c10dc64f4779f2c9fd99bfddb9905ffb))
* **cua-driver:** remove Windows npm VC runtime prerequisite ([#3038](https://github.com/netbospl/cua/issues/3038)) ([c167125](https://github.com/netbospl/cua/commit/c167125e1bb0c4fe515beddc0d480f573f3c6077))
* **cua-driver:** repair X11 overlay after display changes ([#2354](https://github.com/netbospl/cua/issues/2354)) ([81019b5](https://github.com/netbospl/cua/commit/81019b54b89d577ccb5d7758eba0fd33861fc9d9))
* **cua-driver:** report honest macOS browser chrome coverage ([#2919](https://github.com/netbospl/cua/issues/2919)) ([7c52b84](https://github.com/netbospl/cua/commit/7c52b8449fab36cdda9fe4310e6afd3be202c955))
* **cua-driver:** report macOS key delivery truthfully ([#2830](https://github.com/netbospl/cua/issues/2830)) ([3dc0fc0](https://github.com/netbospl/cua/commit/3dc0fc0e345f6d8107899a18c74245615e294c03))
* **cua-driver:** report macOS Retina backing scale ([#3328](https://github.com/netbospl/cua/issues/3328)) ([9029514](https://github.com/netbospl/cua/commit/90295148d34dac8e5a1307bac917e08171af5839))
* **cua-driver:** report PostMessage pixel fallback truthfully ([4dc537e](https://github.com/netbospl/cua/commit/4dc537ef34e715c099ab30c7d45618e791da2ad1))
* **cua-driver:** reset stale local TCC rows after ad-hoc rebuilds ([#2747](https://github.com/netbospl/cua/issues/2747)) ([ee09e86](https://github.com/netbospl/cua/commit/ee09e869727ce1f80793b0dd830a29139cb6fffa))
* **cua-driver:** resolve Linux launch_app names via .desktop entries and surface xdg-open failures ([#2954](https://github.com/netbospl/cua/issues/2954)) ([fb4b492](https://github.com/netbospl/cua/commit/fb4b492cd997dd3e8659298adfd98825974ebb7e))
* **cua-driver:** scope the Linux AT-SPI walk to the requested window ([#2895](https://github.com/netbospl/cua/issues/2895)) ([8c515ca](https://github.com/netbospl/cua/commit/8c515ca74d7f9dad2b3ae9d74b59294511824fa1))
* **cua-driver:** select macOS collection items reliably ([4be90ea](https://github.com/netbospl/cua/commit/4be90ea11345535decb1baacde14c0313338f1c6))
* **cua-driver:** select the correct Linux AT-SPI application tree ([#2740](https://github.com/netbospl/cua/issues/2740)) ([d86e49b](https://github.com/netbospl/cua/commit/d86e49ba4bf1c456fd16eca220184a38600ed927))
* **cua-driver:** stage current skill pack on Windows local installs ([#3083](https://github.com/netbospl/cua/issues/3083)) ([b4bc58a](https://github.com/netbospl/cua/commit/b4bc58a3a262f30fcd9d6772851cde0f3429deb6))
* **cua-driver:** stage local installs over a running driver ([#2889](https://github.com/netbospl/cua/issues/2889)) ([157816e](https://github.com/netbospl/cua/commit/157816e6144a79162253762b79d0abdfffa8e486))
* **cua-driver:** stop the serve daemon in the Unix release uninstaller ([#3340](https://github.com/netbospl/cua/issues/3340)) ([45c256b](https://github.com/netbospl/cua/commit/45c256bc826c13e6c0667b9891c4ce4ab0e635af))
* **cua-driver:** stop Windows update --apply from killing itself ([#2805](https://github.com/netbospl/cua/issues/2805)) ([aebd996](https://github.com/netbospl/cua/commit/aebd9962d2686e75ff9e17e0a3735e303ff96981))
* **cua-driver:** strip UTF-8 BOM from uninstall.ps1 ([da44420](https://github.com/netbospl/cua/commit/da44420193b59e845887db1f6c4adf27fbb2ffb8)), closes [#3174](https://github.com/netbospl/cua/issues/3174)
* **cua-driver:** survive z-order BadMatch under reparenting WMs so the Linux agent cursor can paint ([#2957](https://github.com/netbospl/cua/issues/2957)) ([9522358](https://github.com/netbospl/cua/commit/9522358294f34aba138221e87d3dbb79486b199a)), closes [#2955](https://github.com/netbospl/cua/issues/2955)
* **cua-driver:** tell operators to reconnect agent sessions after history enable ([#3224](https://github.com/netbospl/cua/issues/3224)) ([62ede45](https://github.com/netbospl/cua/commit/62ede45ad8450e341e9521bb8a8f81c9705f1c12)), closes [#3220](https://github.com/netbospl/cua/issues/3220)
* **cua-driver:** tolerate missing local autostart task ([#3229](https://github.com/netbospl/cua/issues/3229)) ([f913244](https://github.com/netbospl/cua/commit/f9132440013edaf99937682ea3ad44326ae16df2))
* **cua-driver:** verify exact macOS window activation ([#2829](https://github.com/netbospl/cua/issues/2829)) ([cd5c6f3](https://github.com/netbospl/cua/commit/cd5c6f3ec5c2f71a8fbc64563d42933d381008ba))
* **cua-driver:** verify foreground focus before input ([#3068](https://github.com/netbospl/cua/issues/3068)) ([f9192dd](https://github.com/netbospl/cua/commit/f9192dde69dd85ff6c5ad0bf4731d33ebc7d20d3))
* **cua-driver:** write the update-check cache to the canonical home ([#3032](https://github.com/netbospl/cua/issues/3032)) ([69e5774](https://github.com/netbospl/cua/commit/69e57742751407258f2189ec2c4bb21fba78da2e))


### Performance Improvements

* **cua-driver:** accelerate Linux X11 capture with MIT-SHM ([#2796](https://github.com/netbospl/cua/issues/2796)) ([5448c44](https://github.com/netbospl/cua/commit/5448c449c81c81a7e48a418f8276d257f0e4c563))
* **cua-driver:** accelerate macOS window capture with ScreenCaptureKit ([#2795](https://github.com/netbospl/cua/issues/2795)) ([bc90373](https://github.com/netbospl/cua/commit/bc90373362cb7c521b1ff03f94457d5de618095c))


### Reverts

* **cua-driver:** remove native Agent View presentation ([#3452](https://github.com/netbospl/cua/issues/3452)) ([47452be](https://github.com/netbospl/cua/commit/47452be2da82cbfe71d6a13bb0d5afd83502eef5))
